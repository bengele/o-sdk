...
//        UtNttLog.d(TAG,END_LINE);
    ...
    public void printJsonResponse(long chainMs, boolean isSuccessful, int code, @NonNull String headers, @Nullable MediaType contentType,
        ...
        bodyString = HttpResponseInterceptor.isJson(contentType) ? CharacterUtil.jsonFormat(bodyString)
                : HttpResponseInterceptor.isXml(contentType) ? CharacterUtil.xmlFormat(bodyString) : bodyString;
...
//        UtNttLog.d(TAG,RESPONSE_UP_LINE);
